...
program main
    implicit none
    integer,parameter::ndt=100,nb=25,nx=400
    integer i,j,k
    real*8 t(nb,nb),dx,l,v(nb,nb),dt,xst,xed,pi,x,phii,phij,part(nb,nb),g
